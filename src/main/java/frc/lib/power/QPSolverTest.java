    ...
    public static void main(String[] args) {
        ...
        Calcfc calcfc = new Calcfc() {
            ...
            public double Compute(int n, int m, double[] x, double[] con) {
                con[0] = 300 - ((140 * x[0]) + (100 * x[1]) + (140 * x[2]) + (100 * x[3])); /* 140*x_0 + 100*x_1 + 140*x_2 + 100*x_3 <= 120 */
                con[1] = 1 - x[0]; /* x_0 <= 1 */
                con[2] = 1 - x[1]; /* x_1 <= 1 */
                con[3] = 1 - x[2]; /* x_2 <= 1 */
                con[4] = 1 - x[3]; /* x_3 <= 1 */
                ...
                return -0.3 * Math.pow(x[0], 2.0) + -0.5 * Math.pow(x[1], 2.0) + -0.4 * Math.pow(x[2], 2.0) + -0.6 * Math.pow(x[3], 2.0);
            }
        };
        ...
        System.out.println(x[0] * 140);
        System.out.println(x[1] * 100);
        System.out.println(x[2] * 140);
